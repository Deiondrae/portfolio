...
problem-solver with a keen eye for opportunities to improve user experience. Extremely open minded
and excited to join a fast-paced team that will allow me to build on my fundamentals and grow.
                    </p>
                    <div className="flex justify-center">
                        ...
                        <a href="#projects" className="ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg">View my work</a>
                    </div>
                </div>
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img className="object-cover object-center rounded" alt="hero" src="../../logo.svg"></img>
                </div>
            </div>
        </section>
    )
